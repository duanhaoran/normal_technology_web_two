<template>
  <div class="student-table-component">
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            circle
            size="small"
            @click="ViewModel(scope.row.personId)"
          ...
          <el-button
            ...
            circle
            size="small"
            @click="UpdateModel(scope.row.personId)"
            class="staff-table-opera-btn">
          </el-button>
          <!--删除详情按钮-->
          <el-button
            ...
            circle
            size="small"
            @click="DeleteModel(scope.row.personId)"
            class="staff-table-opera-btn">
          </el-button>
        </template>
      </el-table-column>
    ...
    <!-- 查看详情的模态框 -->
    <el-dialog title="详情" :visible.sync="viewVisible" center width="35%" top="6vh">
      <!-- 下划线 -->
    ...
    export default {
      ...
      data() {
        return {
          ...
          personStats: '',
          //url
          selectByAny:'/api/person/selectPersonByAny',
          selectOne:'/api/person/selectPersonOne',
      ...
      created() {
        ...
        this.$axios.get(
          this.selectByAny,
          {pageNum:this.pageNum,pageSize:this.pageSize,personType:'监察'},
          (res) => {
            if (res.resultCode === 1) {
