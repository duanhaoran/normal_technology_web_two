...
<!--      </el-col>-->
      <el-col :span="12">
        <el-select v-model="SelectModel.setMealSpotId" placeholder="请选择景点">
          <el-option
...
<!--                   @click="download(`/api/setMeal/Exporttemplate`,'信息.xls')">-->
<!--          信息下载-->
<!--        </el-button>-->
<!--      </el-col>-->
      <!--信息添加按钮-->
...
<!--            circle-->
<!--            size="small"-->
<!--            @click="ViewModel(scope.row.setMealId)"-->
...
<!--            circle-->
<!--            size="small"-->
<!--            @click="UpdateModel(scope.row.setMealId)"-->
<!--            class="staff-table-opera-btn">-->
<!--          </el-button>-->
          <!--删除详情按钮-->
          <el-button
            ...
            circle
            size="small"
            @click="DeleteModel(scope.row.setMealId)"
            class="staff-table-opera-btn">
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="店铺详情" :visible.sync="viewVisible" center width="35%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left">
        <el-form-item label="套餐ID">
          <span>{{ InfoModel.setMealId }}</span>
        </el-form-item>
        <el-form-item label="套餐内容">
          <span>{{ InfoModel.setMealContent }}</span>
        </el-form-item>
        <el-form-item label="套餐主题">
          <span>{{ InfoModel.setMealTheme }}</span>
        </el-form-item>
        <el-form-item label="套餐所属景点">
          <span>{{ InfoModel.setMealSpotId }}</span>
        </el-form-item>
      </el-form>
    </el-dialog>
    <!-- 修改详情的模态框 -->
    <el-dialog title="信息修改" :visible.sync="updateVisible" center width="40%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left" >
        ...
        <el-form-item label="套餐ID" prop="setMealId">
          <el-col :span="12">
            <el-input v-model="InfoModel.setMealId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="套餐内容" prop="setMealContent">
          <el-col :span="12">
            <el-input v-model="InfoModel.setMealContent" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="套餐主题" prop="setMealTheme">
          <el-col :span="12">
            <el-input v-model="InfoModel.setMealTheme" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="套餐所属景点" prop="setMealSpotId">
          <el-col :span="12">
            <el-input v-model="InfoModel.setMealSpotId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!--信息修改按钮-->
        <el-form-item>
    ...
    <el-dialog title="信息添加" :visible.sync="insertVisible" center width="40%" top="6vh">
      ...
      <el-form :model="AddModel"  label-width="90px" label-position="left">
        ...
        <el-form-item label="套餐ID" prop="setMealId">
          <el-col :span="12">
            <el-input v-model="AddModel.setMealId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="套餐内容" prop="setMealContent">
          <el-col :span="12">
            <el-input v-model="AddModel.setMealContent" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="套餐主题" prop="setMealTheme">
          <el-col :span="12">
            <el-input v-model="AddModel.setMealTheme" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="套餐所属景点" prop="setMealSpotId">
          <el-col :span="12">
            <el-input v-model="AddModel.setMealSpotId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!-- 操作按钮 -->
        <el-form-item>
    ...
    export default {
      ...
      data() {
        return {
          ...
          setMealSpotId: '',
          //url
          selectByAny:'/api/setMeal/selectSetMealByAny',
          selectOne:'/api/setMeal/selectSetMealOne',
          updateOne:'/api/setMeal/updateSetMealOne',
          insertOne:'/api/setMeal/insertSetMealOne',
          deleteByList:'/api/setMeal/deleteSetMealByList',
          deleteOne:'/api/setMeal/deleteSetMealOne',
        ...
        SelectByAny() {
          this.$axios.get(
            this.selectByAny,
            {
              ...
              setMealSpotId: this.SelectModel.setMealSpotId
            },
            (res) => {
              if (res.resultCode === 1) {
                this.successMession();
