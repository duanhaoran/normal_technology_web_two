...
<!--      </el-col>-->
      <el-col :span="12">
        <el-select v-model="SelectModel.interactionScenicSpotId" placeholder="请选择景点">
          <el-option
...
<!--                   @click="download(`/api/interaction/Exporttemplate`,'信息.xls')">-->
<!--          信息下载-->
<!--        </el-button>-->
<!--      </el-col>-->
      <!--信息添加按钮-->
...
<!--      </el-table-column>-->
      ...
      <el-table-column
        prop="interactionScenicSpotName"
        label="对应景点"
        width="200"
        align="center"
      >
...
<!--            circle-->
<!--            size="small"-->
<!--            @click="ViewModel(scope.row.interactionId)"-->
...
<!--            circle-->
<!--            size="small"-->
<!--            @click="UpdateModel(scope.row.interactionId)"-->
<!--            class="staff-table-opera-btn">-->
<!--          </el-button>-->
          <!--删除详情按钮-->
          <el-button
            ...
            circle
            size="small"
            @click="DeleteModel(scope.row.interactionId)"
            class="staff-table-opera-btn">
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="店铺详情" :visible.sync="viewVisible" center width="35%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left">
        <el-form-item label="互动查询主键">
          <span>{{ InfoModel.interactionId }}</span>
        </el-form-item>
        <el-form-item label="互动关键字">
          <span>{{ InfoModel.interactionTheme }}</span>
        </el-form-item>
        <el-form-item label="具体内容">
          <span>{{ InfoModel.interactionContent }}</span>
        </el-form-item>
        <el-form-item label="对应景点">
          <span>{{ InfoModel.interactionScenicSpotId }}</span>
        </el-form-item>
      </el-form>
    </el-dialog>
    <!-- 修改详情的模态框 -->
    <el-dialog title="信息修改" :visible.sync="updateVisible" center width="40%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left" >
        <!--信息列表-->
        <el-form-item label="互动查询主键" prop="interactionId">
          <el-col :span="12">
            <el-input v-model="InfoModel.interactionId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="互动关键字" prop="interactionTheme">
          <el-col :span="12">
            <el-input v-model="InfoModel.interactionTheme" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="具体内容" prop="interactionContent">
          <el-col :span="12">
            <el-input v-model="InfoModel.interactionContent" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="对应景点" prop="interactionScenicSpotId">
          <el-col :span="12">
            <el-input v-model="InfoModel.interactionScenicSpotId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!--信息修改按钮-->
        <el-form-item>
    ...
    <el-dialog title="信息添加" :visible.sync="insertVisible" center width="40%" top="6vh">
      ...
      <el-form :model="AddModel"  label-width="90px" label-position="left">
        ...
        <el-form-item label="互动查询主键" prop="interactionId">
          <el-col :span="12">
            <el-input v-model="AddModel.interactionId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="互动关键字" prop="interactionTheme">
          <el-col :span="12">
            <el-input v-model="AddModel.interactionTheme" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="具体内容" prop="interactionContent">
          <el-col :span="12">
            <el-input v-model="AddModel.interactionContent" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="对应景点" prop="interactionScenicSpotId">
          <el-col :span="12">
            <el-input v-model="AddModel.interactionScenicSpotId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!-- 操作按钮 -->
        <el-form-item>
    ...
    export default {
      ...
      data() {
        return {
          ...
          interactionScenicSpotId: '',
          //url
          selectByAny:'/api/interaction/selectInteractionByAny',
          selectOne:'/api/interaction/selectInteractionOne',
          updateOne:'/api/interaction/updateInteractionOne',
          insertOne:'/api/interaction/insertInteractionOne',
          deleteByList:'/api/interaction/deleteInteractionByList',
          deleteOne:'/api/interaction/deleteInteractionOne',
        ...
        SelectByAny() {
          this.$axios.get(
            this.selectByAny,
            {
              ...
              interactionScenicSpotId: this.SelectModel.interactionScenicSpotId
            },
            (res) => {
              if (res.resultCode === 1) {
                this.successMession();
