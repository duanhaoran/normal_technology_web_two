...
<!--          &lt;!&ndash;修改信息按钮&ndash;&gt;-->
    ...
    <!-- 查看详情的模态框 -->
    <el-dialog title="预定详情" :visible.sync="viewVisible" center width="35%" top="6vh">
      <!-- 下划线 -->
...
<!--        </el-form-item>-->
    ...
    <!-- 修改详情的模态框 -->
    <el-dialog title="预定" :visible.sync="updateVisible" center width="40%" top="6vh">
      <!-- 下划线 -->
      <el-divider><i class="el-icon-mouse"/></el-divider>
      <!-- 信息添加 -->
      <el-form :model="InfoModel" label-width="80px" label-position="left" >
...
<!--        </el-form-item>-->
        ...
        <el-form-item>
          <el-col :span="6">
            <el-button type="success" style="width: 100%;" round @click="handleUpdate()">预定</el-button>
          </el-col>
    ...
    export default {
      ...
      data() {
        return {
          ...
          orderPriority: '',
          //url
          selectByAny:'/api/orderInformain/selectEnter',
          selectOne:'/api/orderInformain/selectOrderInformainOne',
          updateOne:'/api/orderInformain/Updateqiye',
      ...
      methods: {
        ...
        //打开更新
        UpdateModel(id) {
          this.InfoModel.orderUserId=this.proposeOpinionUserId;
          this.InfoModel.orderInformainId=id;
          this.$confirm('是否预定？', '预定确定', {
