  ...
  <div class="student-table-component">
    ...
    <el-row class="drug-table-condition">
      ...
      <el-col :span="4" :offset="1">
        <el-select v-model="SelectModel.industryId" placeholder="请选择监管行业">
          <el-option
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            circle
            size="small"
            @click="ViewModel(scope.row.departmentId)"
          ...
          <el-button
            ...
            circle
            size="small"
            @click="UpdateModel(scope.row.departmentId)"
            class="staff-table-opera-btn">
          </el-button>
          <!--删除详情按钮-->
          <el-button
            ...
            circle
            size="small"
            @click="DeleteModel(scope.row.departmentId)"
            class="staff-table-opera-btn">
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="店铺详情" :visible.sync="viewVisible" center width="35%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left">
        <el-form-item label="部门id">
          <span>{{ InfoModel.departmentId }}</span>
        </el-form-item>
        <el-form-item label="部门名称">
          <span>{{ InfoModel.departmentName }}</span>
        </el-form-item>
        <el-form-item label="部门监管行业id">
          <span>{{ InfoModel.departmentAdministrationInId }}</span>
        </el-form-item>
      </el-form>
    </el-dialog>
    <!-- 修改详情的模态框 -->
    <el-dialog title="信息修改" :visible.sync="updateVisible" center width="40%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left" >
        ...
        <el-form-item label="部门id" prop="departmentId">
          <el-col :span="12">
            <el-input v-model="InfoModel.departmentId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="部门名称" prop="departmentName">
          <el-col :span="12">
            <el-input v-model="InfoModel.departmentName" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="部门监管行业id" prop="departmentAdministrationInId">
          <el-col :span="12">
            <el-input v-model="InfoModel.departmentAdministrationInId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!--信息修改按钮-->
        <el-form-item>
    ...
    <el-dialog title="信息添加" :visible.sync="insertVisible" center width="40%" top="6vh">
      ...
      <el-form :model="AddModel"  label-width="90px" label-position="left">
        ...
        <el-form-item label="部门id" prop="departmentId">
          <el-col :span="12">
            <el-input v-model="AddModel.departmentId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="部门名称" prop="departmentName">
          <el-col :span="12">
            <el-input v-model="AddModel.departmentName" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="部门监管行业id" prop="departmentAdministrationInId">
          <el-col :span="12">
            <el-input v-model="AddModel.departmentAdministrationInId" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!-- 操作按钮 -->
        <el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        departmentAdministrationInId: '',
        //url
        selectByAny:'/api/department/selectDepartmentByAny',
        selectOne:'/api/department/selectDepartmentOne',
        updateOne:'/api/department/updateDepartmentOne',
        insertOne:'/api/department/insertDepartmentOne',
        deleteByList:'/api/department/deleteDepartmentByList',
        deleteOne:'/api/department/deleteDepartmentOne',
      }
    },
    created() {
      //面包屑创建方法
      ...
      SelectByAny() {
        this.$axios.get(
          this.selectByAny,
          {
            ...
            industryId: this.SelectModel.industryId
          },
          (res) => {
            if (res.resultCode === 1) {
              this.successMession();
        ...
        if (this.multipleSelection.length !==0) {
          this.$confirm('是否删除信息？', '警告', {
            ...
            this.multipleSelection.forEach(function (e) {
              listuserId += e.departmentId+','
              ids.push(e.departmentId)
            })
