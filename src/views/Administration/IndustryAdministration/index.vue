...
<!--      </el-col>-->
      ...
      <el-col :span="3" >
        <el-button type="primary"  style="width: 80%;" @click="SelectByAny()"
...
<!--                   @click="download(`/api/industry/Exporttemplate`,'信息.xls')">-->
<!--          信息下载-->
<!--        </el-button>-->
<!--      </el-col>-->
      <!--信息添加按钮-->
    ...
    >
      ...
      <el-table-column
        prop="industryAdministrativeDepartment"
        label="行业管理部门"
        width="200"
        align="center"
      >
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            circle
            size="small"
            @click="ViewModel(scope.row.industryId)"
          ...
          <el-button
            ...
            circle
            size="small"
            @click="UpdateModel(scope.row.industryId)"
            class="staff-table-opera-btn">
          </el-button>
          <!--删除详情按钮-->
          <el-button
            ...
            circle
            size="small"
            @click="DeleteModel(scope.row.industryId)"
            class="staff-table-opera-btn">
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="店铺详情" :visible.sync="viewVisible" center width="35%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left">
        ...
        <el-form-item label="行业管理部门">
          <span>{{ InfoModel.industryAdministrativeDepartment }}</span>
        </el-form-item>
      </el-form>
    </el-dialog>
    <!-- 修改详情的模态框 -->
    <el-dialog title="信息修改" :visible.sync="updateVisible" center width="40%" top="6vh">
      ...
      <el-form :model="InfoModel" label-width="80px" label-position="left" >
        ...
        <el-form-item label="行业名称" prop="industryName">
          <el-col :span="12">
            <el-input v-model="InfoModel.industryName" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="行业管理部门" prop="industryAdministrativeDepartment">
          <el-col :span="12">
            <el-input v-model="InfoModel.industryAdministrativeDepartment" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!--信息修改按钮-->
        <el-form-item>
    ...
    <el-dialog title="信息添加" :visible.sync="insertVisible" center width="40%" top="6vh">
      ...
      <el-form :model="AddModel"  label-width="90px" label-position="left">
        ...
        <el-form-item label="行业名称" prop="industryName">
          <el-col :span="12">
            <el-input v-model="AddModel.industryName" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <el-form-item label="行业管理部门" prop="industryAdministrativeDepartment">
          <el-col :span="12">
            <el-input v-model="AddModel.industryAdministrativeDepartment" clearable style="width: 300px" />
          </el-col>
        </el-form-item>
        <!-- 操作按钮 -->
        <el-form-item>
    ...
    data() {
      return {
        ...
        SelectModel:{
          industryId: '',
          industryName: '',
          industryAdministrativeDepartment: '',
        },
        //分页
        pageNum: 1,
        pageSize: 5,
        ...
        industryAdministrativeDepartment: '',
        //url
        selectByAny:'/api/industry/selectIndustryByAny',
        selectOne:'/api/industry/selectIndustryOne',
        updateOne:'/api/industry/updateIndustryOne',
        insertOne:'/api/industry/insertIndustryOne',
        deleteByList:'/api/industry/deleteIndustryByList',
        deleteOne:'/api/industry/deleteIndustryOne',
      }
    },
    created() {
      //面包屑创建方法
        ...
        if (this.multipleSelection.length !==0) {
          this.$confirm('是否删除信息？', '警告', {
            ...
            this.multipleSelection.forEach(function (e) {
              listuserId += e.industryId+','
              ids.push(e.industryId)
            })
