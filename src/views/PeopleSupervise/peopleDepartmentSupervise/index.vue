...
<!--          </el-col>-->
<!--        </el-form-item>-->
        <el-form-item label="意见部门" prop="opinionEnterprise">
          <el-col :span="12">
            <el-select v-model="AddModel.opinionDepartment" placeholder="请选择部门">
              <el-option
  ...
  export default {
    ...
    data() {
      return {
        ...
        selectByAnyE: '/api/department/selectDepartmentByAny',
      }
    },
    created() {
